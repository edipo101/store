		...
		<header id="masthead" class="site-header header-v2">
			<div class="container">
				<div class="row">
							...
							<nav>
								<ul id="menu-main-menu" class="nav nav-inline yamm">
									...
									<li class="menu-item animate-dropdown">
										...
										<router-link class="nav-link" :to="{name: 'user-table'}">UserTable</router-link>
									</li>
									<li class="menu-item">
										<!-- <a title="Features" href="#">Features</a> -->
										<router-link class="nav-link" :to="{name: 'shop'}">Productos</router-link>
									</li>
					...
					<div class="header-support-info ocultar-div">
						<div class="media">
